...
latest_release=$(curl -sL https://api.github.com/repos/Atmosphere-NX/Atmosphere/releases/latest)
echo $(echo "$latest_release" | jq '.name') >> ../description.txt
download_url=$(echo "$latest_release" | grep -oP '"browser_download_url": "\Khttps://[^"]*atmosphere[^"]*.zip' | sed 's/"//g')
...
download_url=$(echo "$latest_release" | grep -oP '"browser_download_url": "\Khttps://[^"]*fusee.bin' | sed 's/"//g')
...
latest_release=$(curl -sL https://api.github.com/repos/easyworld/hekate/releases/latest)
echo $(echo "$latest_release" | jq '.name') >> ../description.txt
download_url=$(echo "$latest_release" | grep -oP '"browser_download_url": "\Khttps://[^"]*hekate_ctcaer[^"]*_sc.zip' | sed 's/"//g')
...
latest_release=$(curl -sL https://api.github.com/repos/zdm65477730/Lockpick_RCMDecScots/releases/latest)
echo $(echo "$latest_release" | jq '.name') >> ../description.txt
download_url=$(echo "$latest_release" | grep -oP '"browser_download_url": "\Khttps://[^"]*Lockpick_RCM.bin' | sed 's/"//g')
...
latest_release=$(curl -sL https://api.github.com/repos/zdm65477730/TegraExplorer/releases/latest)
echo $(echo "$latest_release" | jq '.name') >> ../description.txt
download_url=$(echo "$latest_release" | grep -oP '"browser_download_url": "\Khttps://[^"]*TegraExplorer.bin' | sed 's/"//g')
...
latest_release=$(curl -sL https://api.github.com/repos/zdm65477730/CommonProblemResolver/releases/latest)
echo $(echo "$latest_release" | jq '.name') >> ../description.txt
download_url=$(echo "$latest_release" | grep -oP '"browser_download_url": "\Khttps://[^"]*CommonProblemResolver.bin' | sed 's/"//g')
...
latest_release=$(curl -sL https://api.github.com/repos/meganukebmp/Switch_90DNS_tester/releases/latest)
echo Switch_90DNS_tester $(echo "$latest_release" | jq '.tag_name') >> ../description.txt
download_url=$(echo "$latest_release" | grep -oP '"browser_download_url": "\Khttps://[^"]*Switch_90DNS_tester.nro' | sed 's/"//g')
...
latest_release=$(curl -sL https://api.github.com/repos/rashevskyv/dbi/releases/135856657)
echo $(echo "$latest_release" | jq '.name') >> ../description.txt
download_url=$(echo "$latest_release" | grep -oP '"browser_download_url": "\Khttps://[^"]*DBI.nro' | sed 's/"//g')
...
latest_release=$(curl -sL https://api.github.com/repos/dragonflylee/Awoo-Installer/releases/latest)
echo $(echo "$latest_release" | jq '.name') >> ../description.txt
download_url=$(echo "$latest_release" | grep -oP '"browser_download_url": "\Khttps://[^"]*Awoo-Installer.zip' | sed 's/"//g')
...
latest_release=$(curl -sL https://api.github.com/repos/WerWolv/Hekate-Toolbox/releases/latest)
echo HekateToolbox $(echo "$latest_release" | jq '.tag_name') >> ../description.txt
download_url=$(echo "$latest_release" | grep -oP '"browser_download_url": "\Khttps://[^"]*HekateToolbox.nro' | sed 's/"//g')
...
latest_release=$(curl -sL https://api.github.com/repos/zdm65477730/NX-Activity-Log/releases/latest)
echo $(echo "$latest_release" | jq '.name') >> ../description.txt
download_url=$(echo "$latest_release" | grep -oP '"browser_download_url": "\Khttps://[^"]*NX-Activity-Log.nro' | sed 's/"//g')
...
latest_release=$(curl -sL https://api.github.com/repos/exelix11/SwitchThemeInjector/releases/latest)
echo NXThemesInstaller $(echo "$latest_release" | jq '.tag_name') >> ../description.txt
download_url=$(echo "$latest_release" | grep -oP '"browser_download_url": "\Khttps://[^"]*NXThemesInstaller.nro' | sed 's/"//g')
...
latest_release=$(curl -sL https://api.github.com/repos/J-D-K/JKSV/releases/latest)
echo $(echo "$latest_release" | jq '.name') >> ../description.txt
download_url=$(echo "$latest_release" | grep -oP '"browser_download_url": "\Khttps://[^"]*JKSV.nro' | sed 's/"//g')
...
latest_release=$(curl -sL https://api.github.com/repos/CaiMiao/Tencent-switcher-GUI/releases/latest)
echo tencent-switcher-gui $(echo "$latest_release" | jq '.tag_name') >> ../description.txt
download_url=$(echo "$latest_release" | grep -oP '"browser_download_url": "\Khttps://[^"]*tencent-switcher-gui.nro' | sed 's/"//g')
...
latest_release=$(curl -sL https://api.github.com/repos/HamletDuFromage/aio-switch-updater/releases/latest)
echo aio-switch-updater $(echo "$latest_release" | jq '.tag_name') >> ../description.txt
download_url=$(echo "$latest_release" | grep -oP '"browser_download_url": "\Khttps://[^"]*aio-switch-updater.zip' | sed 's/"//g')
...
echo wiliwili $(echo "$latest_release" | jq '.tag_name') >> ../description.txt
download_url=$(echo "$latest_release" | grep -oP '"browser_download_url": "\Khttps://[^"]*wiliwili-NintendoSwitch.zip' | sed 's/"//g')
...
latest_release=$(curl -sL https://api.github.com/repos/PoloNX/SimpleModDownloader/releases/latest)
echo SimpleModDownloader $(echo "$latest_release" | jq '.tag_name') >> ../description.txt
download_url=$(echo "$latest_release" | grep -oP '"browser_download_url": "\Khttps://[^"]*SimpleModDownloader.nro' | sed 's/"//g')
...
latest_release=$(curl -sL https://api.github.com/repos/dragonflylee/switchfin/releases/latest)
echo $(echo "$latest_release" | jq '.name') >> ../description.txt
download_url=$(echo "$latest_release" | grep -oP '"browser_download_url": "\Khttps://[^"]*Switchfin.nro' | sed 's/"//g')
...
latest_release=$(curl -sL https://api.github.com/repos/XITRIX/Moonlight-Switch/releases/latest)
echo Moonlight $(echo "$latest_release" | jq '.tag_name') >> ../description.txt
download_url=$(echo "$latest_release" | grep -oP '"browser_download_url": "\Khttps://[^"]*Moonlight-Switch.nro' | sed 's/"//g')
...
latest_release=$(curl -sL https://api.github.com/repos/zdm65477730/NX-Shell/releases/latest)
echo $(echo "$latest_release" | jq '.name') >> ../description.txt
download_url=$(echo "$latest_release" | grep -oP '"browser_download_url": "\Khttps://[^"]*NX-Shell.nro' | sed 's/"//g')
...
latest_release=$(curl -sL https://api.github.com/repos/fortheusers/hb-appstore/releases/latest)
echo $(echo "$latest_release" | jq '.name') >> ../description.txt
download_url=$(echo "$latest_release" | grep -oP '"browser_download_url": "\Khttps://[^"]*appstore.nro' | sed 's/"//g')
...
latest_release=$(curl -sL https://api.github.com/repos/zdm65477730/nx-ovlloader/releases/latest)
echo $(echo "$latest_release" | jq '.name') >> ../description.txt
download_url=$(echo "$latest_release" | grep -oP '"browser_download_url": "\Khttps://[^"]*nx-ovlloader.zip' | sed 's/"//g')
...
latest_release=$(curl -sL https://api.github.com/repos/zdm65477730/Ultrahand-Overlay/releases/latest)
echo $(echo "$latest_release" | jq '.name') >> ../description.txt
download_url=$(echo "$latest_release" | grep -oP '"browser_download_url": "\Khttps://[^"]*Ultrahand.zip' | sed 's/"//g')
...
latest_release=$(curl -sL https://api.github.com/repos/zdm65477730/EdiZon-Overlay/releases/latest)
echo $(echo "$latest_release" | jq '.name') >> ../description.txt
download_url=$(echo "$latest_release" | grep -oP '"browser_download_url": "\Khttps://[^"]*EdiZon.zip' | sed 's/"//g')
...
latest_release=$(curl -sL https://api.github.com/repos/zdm65477730/ovl-sysmodules/releases/latest)
echo $(echo "$latest_release" | jq '.name') >> ../description.txt
download_url=$(echo "$latest_release" | grep -oP '"browser_download_url": "\Khttps://[^"]*ovl-sysmodules.zip' | sed 's/"//g')
...
latest_release=$(curl -sL https://api.github.com/repos/zdm65477730/Status-Monitor-Overlay/releases/latest)
echo $(echo "$latest_release" | jq '.name') >> ../description.txt
download_url=$(echo "$latest_release" | grep -oP '"browser_download_url": "\Khttps://[^"]*StatusMonitor.zip' | sed 's/"//g')
...
latest_release=$(curl -sL https://api.github.com/repos/zdm65477730/ReverseNX-RT/releases/latest)
echo $(echo "$latest_release" | jq '.name') >> ../description.txt
download_url=$(echo "$latest_release" | grep -oP '"browser_download_url": "\Khttps://[^"]*ReverseNX-RT.zip' | sed 's/"//g')
...
latest_release=$(curl -sL https://api.github.com/repos/zdm65477730/ldn_mitm/releases/latest)
echo $(echo "$latest_release" | jq '.name') >> ../description.txt
download_url=$(echo "$latest_release" | grep -oP '"browser_download_url": "\Khttps://[^"]*ldn_mitm.zip' | sed 's/"//g')
...
latest_release=$(curl -sL https://api.github.com/repos/zdm65477730/emuiibo/releases/latest)
echo $(echo "$latest_release" | jq '.name') >> ../description.txt
download_url=$(echo "$latest_release" | grep -oP '"browser_download_url": "\Khttps://[^"]*emuiibo.zip' | sed 's/"//g')
...
latest_release=$(curl -sL https://api.github.com/repos/zdm65477730/QuickNTP/releases/latest)
echo $(echo "$latest_release" | jq '.name') >> ../description.txt
download_url=$(echo "$latest_release" | grep -oP '"browser_download_url": "\Khttps://[^"]*QuickNTP.zip' | sed 's/"//g')
...
latest_release=$(curl -sL https://api.github.com/repos/zdm65477730/Fizeau/releases/latest)
echo $(echo "$latest_release" | jq '.name') >> ../description.txt
download_url=$(echo "$latest_release" | grep -oP '"browser_download_url": "\Khttps://[^"]*Fizeau.zip' | sed 's/"//g')
...
latest_release=$(curl -sL https://api.github.com/repos/HookedBehemoth/sys-tune/releases/latest)
echo $(echo "$latest_release" | jq '.name') >> ../description.txt
download_url=$(echo "$latest_release" | grep -oP '"browser_download_url": "\Khttps://[^"]*sys-tune[^"]*.zip' | sed 's/"//g')
...
latest_release=$(curl -sL https://api.github.com/repos/zdm65477730/sys-patch/releases/latest)
echo sys-patch $(echo "$latest_release" | jq '.tag_name') >> ../description.txt
download_url=$(echo "$latest_release" | grep -oP '"browser_download_url": "\Khttps://[^"]*sys-patch.zip' | sed 's/"//g')
...
latest_release=$(curl -sL https://api.github.com/repos/zdm65477730/sys-clk/releases/latest)
echo $(echo "$latest_release" | jq '.name') >> ../description.txt
download_url=$(echo "$latest_release" | grep -oP '"browser_download_url": "\Khttps://[^"]*sys-clk[^"]*.zip' | sed 's/"//g')
...
latest_release=$(curl -sL https://api.github.com/repos/halop/OC_Toolkit_SC_EOS/releases/latest)
echo $(echo "$latest_release" | jq '.name') >> ../description.txt
download_url_1=$(echo "$latest_release" | grep -oP '"browser_download_url": "\Khttps://[^"]*kip.zip' | sed 's/"//g')
download_url_2=$(echo "$latest_release" | grep -oP '"browser_download_url": "\Khttps://[^"]*OC.Toolkit.u.zip' | sed 's/"//g')
...
latest_release=$(curl -sL https://api.github.com/repos/ndeadly/MissionControl/releases/latest)
echo $(echo "$latest_release" | jq '.name') >> ../description.txt
download_url=$(echo "$latest_release" | grep -oP '"browser_download_url": "\Khttps://[^"]*MissionControl[^"]*.zip' | sed 's/"//g')
